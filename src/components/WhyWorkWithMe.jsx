...
function MobileStackGroup2({ cards, scrollYProgress, enterStart, enterEnd, fanStart, fanEnd, holdEnd, fadeoutEnd }) {
  ...
  /* Left card moves left by 92px, Right card moves right by 92px */
...
function DesktopGroupDots({ scrollYProgress }) {
  ...
  const g2Op = useTransform(scrollYProgress, [0.52, 0.59, 0.90, 0.96], [0, 1, 1, 0]);
  return (
    <>
      <motion.div
...
function MobileGroupDots({ scrollYProgress }) {
  ...
  const g3Op = useTransform(scrollYProgress, [0.69, 0.74, 0.95, 0.99], [0, 1, 1, 0]);
  return (
    <>
      <motion.div
...
export default function WhyWorkWithMe() {
  ...
  return (
    <section
      ...
      style={{ height: isMobile ? '400vh' : '420vh' }}
    >
      {/* Ambient glow */}
